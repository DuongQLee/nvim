return {
  ...
  opts = {
    ...
    presets = {
      ...
      command_palette = true,       -- position command vertically and centered
    ...
    views = {
      cmdline_popup = {
        -- !!! THESE ARE THE CORRECT LOCATION FOR POSITION AND SIZE !!!
        position = {
        ...
        -- You can also add win_options here if needed
        -- win_options = {
